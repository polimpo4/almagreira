...
?>" novalidate>   
                    ...
                    <p class="comment-form-author">
                        ...
                        <label><?php _e('Nome', 'Mercycorp'); ?><span><?php _e('(Obrigatório)', 'Mercycorp'); ?></span></label>
                    ...
                    <p class="comment-form-email">
                        ...
                        <label><?php _e('Email', 'Mercycorp'); ?><span><?php _e('(Obrigatório)', 'Mercycorp'); ?></span></label>
                    ...
                    <p class="comment-form-contact">
                        ...
                        <label><?php if ($cs_theme_option['trans_switcher'] == "on") {

                          _e('Subject', 'Mercycorp');

                      } else {

                          echo $cs_theme_option['trans_subject'];

                      } ?><span><?php _e('(Obrigatório)', 'Mercycorp'); ?></span></label>
                    ...
                    <p class="comment-form-comment">
                        ...
                        <label><?php if ($cs_theme_option['trans_switcher'] == "on") {
                          ...
                          _e('Message', 'Mercycorp');

                      } else {

                          echo $cs_theme_option['trans_message']; ?><span><?php _e('(Obrigatório)', 'Mercycorp');
                    ...
                    <p class="form-submit">
                        ...
                        <input type="submit" value="<?php _e('Enviar', 'Mercycorp'); ?>" id="submit_btn<?php echo $cs_counter_node ?>" class="backcolr">

                        <span><?php /* if ($cs_theme_option['trans_switcher'] == "on") {

                          _e('*Your Email will never published.', 'Mercycorp');

                      } else {

                          echo $cs_theme_option['trans_email_published'];
