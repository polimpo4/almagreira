...
class CHIMP_MC_Plugin {
    ...
    private static $textdomain = 'Mercycorp';
    ...
    public function get_admin_notices() {
        ...
        $notice .= __('You\'ll need to set up the MailChimp signup widget plugin options before using it', 'Mercycorp') . __('You can make your changes', 'Mercycorp') . ' <a href="' . get_admin_url($blog_id) . 'themes.php?page=cs_theme_options#tab-mailchimp-key-show">' . __('here', 'Mercycorp') . '.</a>';
