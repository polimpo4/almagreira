...
add_filter('manage_albums_posts_columns', 'gallery_columns_add');
...
add_action('manage_albums_posts_custom_column', 'gallery_columns');
...
function albums_register() {
    $labels = array(
        'name' => __('Galeria', 'Mercycorp'),
        'add_new_item' => __('Add New Gallery', 'Mercycorp'),
        'edit_item' => __('Edit Gallery', 'Mercycorp'),
        'new_item' => __('New Gallery Item', 'Mercycorp'),
        'add_new' => __('Add New Gallery', 'Mercycorp'),
        'view_item' => __('View Gallery Item', 'Mercycorp'),
        'search_items' => __('Search Gallery', 'Mercycorp'),
...
function cs_meta_gallery_add() {
    add_meta_box('cs_meta_gallery', __('Gallery Options', 'Mercycorp'), 'cs_meta_gallery', 'albums', 'normal', 'high');
}
                ...
                <div class="to-social-network">
                    <div class="gal-active">
                        ...
                        <div class="dragareamain">
                            <div class="placehoder"><?php _e('Gallery is Empty. Please Select Media', 'Mercycorp'); ?> <img src="<?php echo get_template_directory_uri() ?>/images/admin/bg-arrowdown.png" alt="" /></div>
                            <ul id="gal-sortable">
                                <?php
                    ...
                    <div class="to-social-list">
                        <div class="soc-head">
                            ...
                            <div class="right">
                                ...
                                <input id="cs_log" name="cs_logo" type="button" class="uploadfile button" value="<?php _e('Upload Media', 'Mercycorp'); ?>" />
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <script>
                            jQuery(document).ready(function ($) {
                                ...
                                $('body').append("#gal-sortable").clone();
                            });
                            var counter = 0;
    ...
    function cs_meta_gallery_options($post_id) {
        ...
        if (isset($_POST['path'])) {
            foreach ($_POST['path'] as $count) {
                ...
                $gallery->addChild('description', htmlspecialchars($_POST['description'][$cs_counter]));
