...
function cs_slider_register() {
    ...
    //adding columns end
    $labels = array(
        'name' => __('Sliders', 'Mercycorp'),
        'add_new_item' => __('Add New Slider', 'Mercycorp'),
        'edit_item' => __('Edit Slider', 'Mercycorp'),
        'new_item' => __('New Slider Item', 'Mercycorp'),
        'add_new' => __('Add New Slider', 'Mercycorp'),
        'view_item' => __('View Slider Item', 'Mercycorp'),
        'search_items' => __('Search Slider', 'Mercycorp'),
...
function cs_meta_slider_add() {
    add_meta_box('cs_meta_slider', __('Slider Options', 'Mercycorp'), 'cs_meta_slider', 'cs_slider', 'normal', 'high');
}
                ...
                <div class="to-social-network">
                    <div class="gal-active">
                        ...
                        <div class="dragareamain">
                            <div class="placehoder"><?php _e('Slider is Empty. Please Select Media', 'Mercycorp'); ?> <img src="<?php echo get_template_directory_uri() ?>/images/admin/bg-arrowdown.png" alt="" /></div>
                            <ul id="gal-sortable">
                                <?php
                                $cs_counter_slides = 0;
