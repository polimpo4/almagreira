...
[accordion_item active="yes" icon="icon-twitter" title="Accordion Title 1" accordion="accordion"]Accordion Content 1[/accordion_item] <br />\
...
tinyMCE.activeEditor.selection.setContent('[message_box align="left" icon="icon-info-sign" close="yes" color="#COLOR_CODE" background="#COLOR_CODE" border_color="#COLOR_CODE" box_shadow_color="#COLOR_CODE" title="Message Title"]Message Content[/message_box]<br /><br />');
}
else if(v == 'frame'){
...
tinyMCE.activeEditor.selection.setContent('[list type="decimal" icon="icon-ok"]<br />\
...
tinyMCE.activeEditor.selection.setContent('[image-frame style="frame1" width="200" height="150" lightbox="yes" source="" caption="Image Caption"][/image-frame]<br /><br />');
}
else if(v == 'icon'){
tinyMCE.activeEditor.selection.setContent('[icon class="icon-twitter" type="rounded" size="icon-4x" border="no" bgcolor="#000" color="#ff0000"][/icon]<br /><br />');
}
else if(v == 'code'){
...
[social_links]<br />\
[social link="#" target="_blank" icon="icon-facebook" tabs="tabs"]<br />\
[social link="#" target="_blank" icon="icon-twitter" tabs="tabs"]<br />\
[/social_links]<br />\
[/team]<br />\
[team name="JOHN DOE" job="CEO" image=""]<br />\
[content]Team content 2[/content]<br />\
[social_links]<br />\
[social link="#" target="_blank" icon="icon-facebook-sign icon-2x" tabs="tabs"]<br />\
[social link="#" target="_blank" icon="icon-twitter-sign icon-2x" tabs="tabs"]<br />\
[/social_links]<br />\
[/team]<br />\
[/team-sec]<br /><br />');
}
