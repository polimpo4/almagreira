...
function event_columns_add($columns) {
    $columns['category'] = __('Categories', 'Mercycorp');
...
function cs_event_register() {
    $labels = array(
        'name' => __('Events', 'Mercycorp'),
        'add_new_item' => __('Add New Event', 'Mercycorp'),
        'edit_item' => __('Edit Event', 'Mercycorp'),
        'new_item' => __('New Event Item', 'Mercycorp'),
        'add_new' => __('Add New Event', 'Mercycorp'),
        'view_item' => __('View Event Item', 'Mercycorp'),
        'search_items' => __('Search Event', 'Mercycorp'),
    ...
    $labels = array(
        'name' => __('Locations', 'Mercycorp'),
        'add_new_item' => __('Add New Location (Venue Title)', 'Mercycorp'),
        'edit_item' => __('Edit Location', 'Mercycorp'),
        'new_item' => __('New Location Item', 'Mercycorp'),
        'add_new' => __('Add New Location', 'Mercycorp'),
        'view_item' => __('View Location Item', 'Mercycorp'),
        'search_items' => __('Search Location', 'Mercycorp'),
        'not_found' => __('Nothing found', 'Mercycorp'),
        'not_found_in_trash' => __('Nothing found in Trash', 'Mercycorp'),
        'parent_item_colon' => ''
    );
...
function cs_event_categories() {
    $labels = array(
        'name' => __('Event Categories', 'Mercycorp'),
        'search_items' => __('Search Event Categories', 'Mercycorp'),
        'edit_item' => __('Edit Event Category', 'Mercycorp'),
        'update_item' => __('Update Event Category', 'Mercycorp'),
        'add_new_item' => __('Add New Category', 'Mercycorp'),
        'menu_name' => __('Event Categories', 'Mercycorp'),
    );
...
function cs_event_tag() {
    $labels = array(
        'name' => __('Event Tags', 'Mercycorp'),
        'singular_name' => __('event-tag', 'Mercycorp'),
        ...
        'menu_name' => __('Event Tags', 'Mercycorp'),
    );
...
function event_loc_meta() {
    add_meta_box('event_loc_meta', __('Add Location With Map', 'Mercycorp'), 'event_loc_meta_data', 'event-location', 'normal', 'high');
}
            ...
            <div class="option-sec" style="margin-bottom:0;">
                <div class="opt-conts">
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Address', 'Mercycorp'); ?></label></li>
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('City / Town', 'Mercycorp'); ?></label></li>
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Post Code', 'Mercycorp'); ?></label></li>
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Region', 'Mercycorp'); ?></label></li>
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Country', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements noborder">
                        ...
                        <li class="to-field"><input type="button" class="gllpSearchButton" value="<?php _e('Search This Location on Map', 'Mercycorp'); ?>" onclick="gll_search_map()"></li>
                    </ul>
                    <ul class="form-elements">
                        <input type="hidden" name="add_new_loc" class="gllpSearchField" style="margin-bottom:10px;" >
                        <div class="gllpMap"><?php _e('Google Maps', 'Mercycorp'); ?></div>
...
function cs_event_meta() {
    add_meta_box('event_meta', __('Event Options', 'Mercycorp'), 'cs_event_meta_data', 'events', 'normal', 'high');
}
    ...
    <div class="page-wrap">
        <div class="option-sec" style="margin-bottom:0;">
            <div class="opt-conts">
                ...
                <ul class="form-elements">
                    <li class="to-label"><label><?php _e('Footer Widgets', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <div class="on-off"><input type="checkbox" name="switch_footer_widgets"  class="myClass" <?php
                            if (empty($switch_footer_widgets) || $switch_footer_widgets == "on") {
                                echo "checked";
                            }
                            ?> /></div>
                        <p><?php _e('Make footer widgets On/Off', 'Mercycorp'); ?></p>
                    </li>
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label><?php _e('Event Start Date', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                ...
                <ul class="form-elements">
                    <li class="to-label"><label><?php _e('Event End Date', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        ...
                        if ($cs_event_to_date == '')
                            ...
                            ?>" />
                        <p><?php _e('Put event end date', 'Mercycorp'); ?></p>
                    </li>
                </ul>
                <?php if (empty($_GET['post'])) { ?>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Repeat', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                            <select name="repeat" class="dropdown" onchange="toggle_with_value('num_repeat', this.value)">
                                <option value="0"><?php _e('-- Never Repeat --', 'Mercycorp'); ?></option>
                                <option value="+1 day"><?php _e('Every Day', 'Mercycorp'); ?></option>
                                <option value="+1 week"><?php _e('Every Week', 'Mercycorp'); ?></option>
                                <option value="+1 month"><?php _e('Every Month', 'Mercycorp'); ?></option>
                            </select>
                        </li>
                    </ul>
                    <ul class="form-elements" id="num_repeat" style="display:none">
                        <li class="to-label"><label><?php _e('Repeat how many time', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                ...
                <?php } ?>
                <ul class="form-elements">
                    <li class="to-label"><label><?php _e('Events start time from', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        ...
                        <p><?php _e('Start and ending time', 'Mercycorp'); ?></p>
                        <div class="clear"></div>
                        <div class="checkbox-list" style="padding-top:15px;">
                            <div class="checkbox-item">
                                ...
                                <label><?php _e('All Day', 'Mercycorp'); ?></label>
                            </div>
                        </div>
                    </li>
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label><?php _e('Phone No', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <input type="text" id="event_phone_no" name="event_phone_no" value="<?php echo $event_phone_no; ?>" />
                    </li>
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label><?php _e('Buy Now', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <input type="text" id="event_buy_now" name="event_buy_now" value="<?php echo $event_buy_now; ?>" />
                    </li>
                </ul>
                <ul class="form-elements noborder">
                    <li class="to-label"><label><?php _e('Location / Address', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <?php
                        ...
                        <p><?php _e('Put the address', 'Mercycorp'); ?></p>
                    </li>
                </ul>
                <ul class="form-elements" id="event_map">
                    <li class="to-label"><label><?php _e('Show Map', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <div class="on-off"><input type="checkbox"  name="event_map" class="myClass" <?php
                            ...
                            ?> /></div>
                        <p><?php _e('Events Map On / Off', 'Mercycorp'); ?> </p>
                    </li>
                </ul>
            </div>
        </div>
...
if (isset($_POST['event_loc_meta_form']) and $_POST['event_loc_meta_form'] == 1) {
    ...
    function event_loc_meta_save($post_id) {
        if (empty($_POST["event_loc_lat"])) {
            $_POST["event_loc_lat"] = "";
        }
        if (empty($_POST["event_loc_long"])) {
            $_POST["event_loc_long"] = "";
        }
        if (empty($_POST["event_loc_zoom"])) {
            $_POST["event_loc_zoom"] = "";
        }
        ...
        if (empty($_POST["loc_postcode"])) {
            $_POST["loc_postcode"] = "";
        }
        if (empty($_POST["loc_region"])) {
            $_POST["loc_region"] = "";
        }
