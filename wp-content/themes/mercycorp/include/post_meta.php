...
function cs_meta_post_add() {
    add_meta_box('cs_meta_post', __('Post Options', 'Mercycorp'), 'cs_meta_post', 'post', 'normal', 'high');
}
        ...
        <div class="option-sec row">
            <div class="opt-conts">
                ...
                <ul class="form-elements noborder">
                    <li class="to-label"><label><?php _e('Thumbnail View', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <select name="post_thumb_view" class="dropdown" onchange="javascript:new_toggle(this.value)">
                            <option <?php if ($post_thumb_view == "Single Image") echo "selected"; ?> ><?php _e('Single Image', 'Mercycorp'); ?></option>
                            <option <?php if ($post_thumb_view == "Audio") echo "selected"; ?> ><?php _e('Audio', 'Mercycorp'); ?></option>
                            <option <?php if ($post_thumb_view == "Video") echo "selected"; ?> value="Video"><?php _e('Video/Soundcloud', 'Mercycorp'); ?></option>
                            <option <?php if ($post_thumb_view == "Slider") echo "selected"; ?> ><?php _e('Slider', 'Mercycorp'); ?></option>
                        </select>
                        <p></p>
                    </li>
                    <ul class="form-elements" id="post_thumb_image" style="display:<?php
                    ...
                    ?>" >
                        ...
                        <li class="to-field"><p><?php _e('Use Featured Image as Thumbnail', 'Mercycorp'); ?></p></li>
                    </ul>
                    ...
                    if ($post_thumb_view == "Audio")
                        ...
                        echo 'none';
                    ?>" >
                        <li class="to-label"><label><?php _e('Audio Url', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                            ...
                            <input type="button" id="post_thumb_audio2" name="post_thumb_audio2" class="uploadfile left" value="<?php _e('Browse', 'Mercycorp'); ?>"/>
                            <p><?php _e('Enter Specific Audio URL (Youtube, Vimeo and all otheres wordpress supported)', 'Mercycorp'); ?></p>
                        </li>
                    </ul>
                    ...
                    if ($post_thumb_view == "Video")
                        ...
                        echo 'none';
                    ?>" >
                        <li class="to-label"><label><?php _e('Use featured image as video thumbnail', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                            ...
                            <p><?php _e('It will work only for self hosted video', 'Mercycorp'); ?></p>
                        </li>
                        <li class="full">&nbsp;</li>
                        <li class="to-label"><label><?php _e('Thumbnail Video Url', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                            <input id="post_thumb_video2" name="post_thumb_video" value="<?php echo $post_thumb_video ?>" type="text" class="small" />
                            <input id="post_thumb_video2" name="post_thumb_video2" type="button" class="uploadfile left" value="<?php _e('Browse', 'Mercycorp'); ?>"/>
                            <p><?php _e('Enter Specific Video Url (Youtube, Vimeo and all otheres wordpress supported) OR you can select it from your media library', 'Mercycorp'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements" id="post_thumb_slider" style="display:<?php
                    if ($post_thumb_view == "Slider")
                        echo 'inline"';
                    else
                        echo 'none';
                    ?>" >
                        <li class="to-label"><label><?php _e('Select Slider', 'Mercycorp'); ?></label></li>
                        <li class="to-field">
                            <select name="post_thumb_slider" class="dropdown">
                                <option value="0"><?php _e('-- Select Slider --', 'Mercycorp'); ?></option>
                                <?php
                ...
                <ul class="form-elements noborder">
                    <li class="to-label"><label><?php _e('Inside Post Thumbnail View', 'Mercycorp'); ?></label></li>
                    <li class="to-field">
                        <select name="inside_post_thumb_view" class="dropdown" onchange="javascript:new_toggle_inside_post(this.value)">
                            <option <?php if ($inside_post_thumb_view == "Single Image") echo "selected"; ?> ><?php _e('Single Image', 'Mercycorp'); ?></option>
                            <option <?php if ($inside_post_thumb_view == "Audio") echo "selected"; ?> ><?php _e('Audio', 'Mercycorp'); ?></option>
                            <option <?php if ($inside_post_thumb_view == "Video") echo "selected"; ?> value="Video"><?php _e('Video/Soundcloud', 'Mercycorp'); ?></option>
                            <option <?php if ($inside_post_thumb_view == "Slider") echo "selected"; ?> ><?php _e('Slider', 'Mercycorp'); ?></option>
                        </select>
                        <p></p>
                    </li>
                    <ul class="form-elements" id="inside_post_thumb_image" style="display:<?php
                    ...
                    ?>" >
                        ...
                        <li class="to-field">
                            ...
                            <input type="button" id="inside_post_thumb_audio2" name="inside_post_thumb_audio2" class="uploadfile left" value="<?php _e('Browse', 'Mercycorp'); ?>"/>
                            <p><?php _e('Enter Specific Audio URL (Youtube, Vimeo and all otheres wordpress supported)', 'Mercycorp'); ?></p>
                        </li>
                    </ul>
                    ...
                    ?>" >
                        ...
                        <li class="to-field">
                            ...
                            <input id="inside_post_thumb_video2" name="inside_post_thumb_video2" type="button" class="uploadfile left" value="<?php _e('Browse', 'Mercycorp'); ?>"/>
                            <p><?php _e('Enter Specific Video Url (Youtube, Vimeo and all otheres wordpress supported) OR you can select it from your media library', 'Mercycorp'); ?></p>
                        </li>
                    </ul>
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        ...
                        <p><?php _e('Make Social Sharing On/Off', 'Mercycorp'); ?></p>
                    </li>
                </ul>
            </div>
        </div>
