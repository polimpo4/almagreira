	...
	<?php endif; ?>
        ...
        <div class="wpdreams-box" style="float:left;">
            ...
            <div tabid="1">
				...
				<fieldset id="it_media_service" style="display: none !important;">
					<legend>
                ...
                <fieldset id="it_file_indexing">
                    ...
                    <div class="item" wd-show-on="multi_attachment_mime_types_5:text">
                    ...
                    <div class="item" wd-show-on="multi_attachment_mime_types_5:richtext">
                    ...
                    <?php endif; ?>
                    <div class="item" wd-show-on="multi_attachment_mime_types_5:mso_word">
                    ...
                    <div class="item" wd-show-on="multi_attachment_mime_types_5:mso_excel">
                    ...
                    <div class="item" wd-show-on="multi_attachment_mime_types_5:mso_powerpoint">
